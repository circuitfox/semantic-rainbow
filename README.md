...
By highlighting **17** types of semantic tokens each with **10** varations corresponding to different semantic modifiers and an additional **27** shades for combinations of two or more individual modifiers, this theme defines a total of **629** styles for all conceivable (and a few inconceivable) kinds of tokens.
...
## How it works
If 629 styles sounds like too much to configure by hand, you're right.  
...
About 5.72% of styles/transformations are manually defined, stepping in where the automatic generation produced less than optimal results.
